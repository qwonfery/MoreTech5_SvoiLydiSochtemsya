...
public:
	...
	const bool& Emotion() const { return Emotion_; }
	const bool& Reaction() const { return Reaction_; }
	...
	void operator=(const EALSOverlayState NewAction)
	{
		...
		Emotion_ = State == EALSOverlayState::Emotion;
		Reaction_ = State == EALSOverlayState::Reaction;
		Sitting_ = State == EALSOverlayState::Sitting;
	}
};
